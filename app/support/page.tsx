...
export default function SupportPage() {
  return (
    ...
    >
      ...
      <p>
        Include your Whop company ID, a short description of the issue, and any relevant screenshots so we can help faster.
      </p>

      <h2>Best Uses For Support</h2>
      <ul>
        <li>Billing and upgrade questions</li>
        <li>Whop access or installation issues</li>
